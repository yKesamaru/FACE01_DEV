.. FACE01_DEV documentation master file, created by
   sphinx-quickstart on Sun Jul 21 14:23:10 2024.
...
.. raw:: html
   ...
   <div style="display: flex; align-items: center;">
       ...
       <div style="background-color: white; padding: 10px; border-radius: 10px; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2); position: relative;">
           <p style="margin: 10;">''⭐️''FACE01のドキュメントへようこそ！''⭐️''</p>
           <p style="margin: 10;">このドキュメントでは、はじめてFACE01に触れる方のための「ステップ・バイ・ステップ」から、簡単な実装例の「エグザンプル」、そして全てのクラスとメソッドを使いこなすための「face01lib」から構成されています。</p>
